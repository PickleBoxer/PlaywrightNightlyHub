...
export default function Welcome({ reports = [], stats = { totalReports: 0, totalTests: 0, avgSuccessRate: 0, recentReports: 0 } }: WelcomeProps) {
    ...
    return (
        <>
            <Head title="PlaywrightNightlyHub">
                        ...
                        <nav className="flex items-center justify-between">
                            <div className="flex items-center space-x-4">
                                <div className="flex items-center space-x-2">
                                    ...
                                    <h1 className="text-xl font-semibold text-foreground">PlaywrightNightlyHub</h1>
                                </div>
                            </div>
                            <div className="flex items-center space-x-4">
                    ...
                    <div className="container mx-auto px-4">
                        <div className="flex flex-col md:flex-row justify-between items-center">
                            <div className="flex items-center space-x-2 mb-4 md:mb-0">
                                <BarChart3 className="h-5 w-5 text-primary" />
                                <span className="text-sm font-medium">PlaywrightNightlyHub</span>
                            </div>
